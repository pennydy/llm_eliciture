...
# rc_info = "You will read a sentence where the part after \"who\" is missing.  You task is to read the sentence and complete the sentence after \"who\". Please only provide the completion part."
